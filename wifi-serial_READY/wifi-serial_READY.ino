...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "TP-LINK3";  // You will connect your phone to this Access Point
const char *pw = "214365Qq"; // and this is the password
IPAddress ip(192, 168, 5, 1); // From RoboRemo app, connect to this IP
...
#ifdef MODE_STA
// For STATION mode:
const char *ssid = "TP-LINK";  // Your ROUTER SSID
const char *pw = "214365Qq"; // and WiFi PASSWORD
...
#define SERIAL_PARAM0 SERIAL_8N1    // Data/Parity/Stop UART0
#define SERIAL1_TCP_PORT 8888       // Wifi Port UART0
