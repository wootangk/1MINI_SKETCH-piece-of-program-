...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "TP-LINK2";  // You will connect your phone to this Access Point
const char *pw = "213254Qq"; // and this is the password
IPAddress ip(192, 168, 1, 105); // From RoboRemo app, connect to this IP
